...
![Gambar 4: latency breakdown per perangkat](../../experiments/journal_figs/fig8_latency_breakdown.png)

**Gambar 4.** Dekomposisi latensi *end-to-end* per perangkat; garis putus-putus merah menandai anggaran *real-time* 33,3 ms.
