...
Mekanisme kegagalan model *naive* bersifat sistematis: getaran spasial kotak deteksi di sekitar garis virtual memicu event persilangan palsu berulang, orang yang berdiam di dekat garis terhitung berkali-kali, dan pergantian identitas memicu event ganda. *State machine* menghilangkan seluruh *over-count* palsu tersebut dengan mengingat status setiap ID sehingga satu orang hanya terhitung sekali. Studi sensitivitas nilai *cooldown* yang menentukan rentang optimalnya dibahas pada subbab 4.4. Gambar 9 memperlihatkan antarmuka sistem saat pengujian: garis hitung virtual didefinisikan pada koordinat *frame*, dan penghitung menampilkan jumlah masuk-keluar secara langsung saat orang melintasinya.

![Gambar 9: antarmuka sistem counting dengan garis virtual](../../experiments/journal_figs/fig_demo_counting_ui.jpg)

**Gambar 9.** Antarmuka sistem pada pengujian: garis batas virtual (biru) dan penghitung masuk-keluar (*IN/OUT*) terhadap lintasan orang yang melintasinya.
