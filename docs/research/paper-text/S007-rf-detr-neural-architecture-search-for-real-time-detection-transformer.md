...
source_url: https://arxiv.org/pdf/2511.09554
source_file: docs/research/papers/S007-rf-detr-neural-architecture-search-for-real-time-detection-transformer.pdf
source_kind: pdf
extraction_note: downloaded PDF
---

# Extracted text: S007-rf-detr-neural-architecture-search-for-real-time-detection-transformer.pdf
## PDF metadata
- format: PDF 1.7
- title: RF-DETR: Neural Architecture Search for Real-Time Detection Transformers
- author: Isaac Robinson; Peter Robicheaux; Matvei Popov; Deva Ramanan; Neehar Peri
...
to improve the transferability of DETRs to diverse target domains.
Notably,
...
3
RF-DETR: WEIGHT-SHARING NAS WITH FOUNDATION MODELS
...
Published as a conference paper at ICLR 2026
a) Patch Embedding Interpolation
c) Query Dropping
d) Resolution Interpolation
e) Number of Windows
Lower Resolution
Faster
Higher Resolution
...
• Number of Windows per Windowed Attention Block.
Window attention restricts self-
...
acteristics (e.g.
number of images).
Concurrent with DINOv3 (Sim´eoni et al., 2025), we ob-
...
AP75, APSmall, APMedium, and APLarge. Further, we evaluate efficiency by measuring GFLOPs,
...
Interestingly, RT-DETR outperforms D-FINE
...
LW-DETR (M) + Gentler Hyperparameters
# Params.
GFLOPS
Latency (ms)
AP
...
APM
APL
w/ CAEv2 ViT/S-16-Truncated Backbone
28.3M
83.7
4.4
52.3
...
a batch size of 128 (LW-DETR uses the same). Similar to DINOv3 (Sim´eoni et al., 2025), we use
...
names on RF100-VL in Table 10.
Intuitively, GroundingDINO’s vision-language pre-training
...
Model
Size # Params. GFLOPS Latency (ms) AP AP50 AP75 APS APM APL
RF100-VL
GroundingDINO (Liu et al., 2023) w/ Standard Class Names
T
173.0M
1008.3
309.9∗
62.3 88.8
67.8 39.2 57.7 69.5
GroundingDINO (Liu et al., 2023) w/ Class Index Names
T
173.0M
1008.3
309.9∗
...
71.7
G
IMPACT OF NAS FINE-TUNING ON COCO
...
45.3
63.6
RF-DETR-Seg. w/ Fine-Tuning (Ours)
N
33.6M
50.0
3.4
...
-
H
IMPACT OF DATASET CHARACTERISTICS ON TUNABLE KNOBS
...
Relationship
Slope
Intercept R-squared P-value Std. Error
Average Object Size vs Number of Spatial Locations
-0.009
0.384
0.148
0.000
0.002
Average Object Size vs Number of Decoder Layers
-0.000
0.044
0.000
0.971
0.006
Average Object Size vs Number of Windows
-0.008
0.065
0.019
0.170
0.006
Number of Classes vs Number of Decoder Layers
0.837
2.125
0.026
0.106
0.513
Number of Annotations vs Number of Decoder Layers
698.763 6654.795
0.001
0.706
1848.733
Average Objects per Image vs Number Decoder Layers
0.163
7.618
0.000
0.857
0.904
Average Objects per Image vs Number of Queries
0.020
4.457
0.019
0.171
0.015
Number of Spatial Locations vs Number of Windows
1.722
32.984
0.492
0.000
...
Table 18 and Figure 7.
We find that these fixed architecture models perform remarkably well
...
Size # Params. GFLOPS Latency (ms) AP AP50 AP75 APS APM APL
End-to-End Real-Time Object Detectors
RF-DETR (Ours) Fixed Architecture
N
30.5M
31.9
2.3
...
56.4
70.2
RF-DETR (Ours) w/ Fixed Architecture
L
33.9M
125.6
6.8
...
57.2
70.3
RF-DETR (Ours, DINOv2-Base) w/ Fixed Architecture XL
126.4M
299.3
11.5
62.9 88.5
...
58.2
70.6
RF-DETR (Ours, DINOv2-Base) w/ Fixed Architecture 2XL
126.9M
438.4
17.1
63.2 89.0
...
58.2
71.6
RF-DETR (Ours, DINOv2-Base) w/ Fine-Tuning
2XL
123.5M
410.2
15.6
...
71.7
J
ABLATION ON BACKBONE ARCHITECTURE WITH RF20-VL
...
to 1
4 of the input image resolution. As a result, scaling RF-DETR-Seg’s input resolution affects
