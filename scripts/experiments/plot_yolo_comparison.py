...
fig.suptitle('YOLO Models Comparison on GPU Server (RTX 4090)', fontsize=16)

# Plot 1: FPS comparison
axes[0].bar(df['Model'], df['Avg_FPS'])
...
axes[1].bar(df['Model'], df['Avg_Confidence'])
...
# Save the plot
output_img = "experiments/output-rtx4090.png"
